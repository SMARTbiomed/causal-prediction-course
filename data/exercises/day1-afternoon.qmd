...
-   **Predictors:** 
    ...
    -   `HBA1C_0`, `HBA1C_1`: Glycated hemoglobin, also called hemoglobin A1C value at two time points in mmol/mol. Smaller
        values indicate better glycemic control.
    -   `urine_albumin_0`, `urine_albumin_1`: The urine albumin to creatinine ratio, in mg/g. A larger relative
    ...
    -   `eGFR_0`, `eGFR_1`: Estimated glomerular filtration rate, in $mL/min/1.73m^2$. An estimate of kidney function, larger
...
- [Training set](/data/exercises/data/type1-diabetes-train.rds): For developing your risk prediction model.
- [Test set](/data/exercises/data/type1-diabetes-test.rds): For evaluating your risk prediction model. 
- [Deployment set](/data/exercises/data/type1-diabetes-deployment.rds): For predicting unknown outcome and sending to the honest broker for testing.
...
test <- readRDS(url("https://smartbiomed.github.io/causal-prediction-course/data/exercises/data/type1-diabetes-train.rds"))
```
...
9. Once you have decided on your new risk prediction model, load the deployment dataset and produce predicted probabilities of cvd_5year. Insert them into a new variable in the dataset, save the result 

```{r}
valid <- readRDS(url("https://smartbiomed.github.io/causal-prediction-course/data/exercises/data/type1-diabetes-deployment.rds"))
