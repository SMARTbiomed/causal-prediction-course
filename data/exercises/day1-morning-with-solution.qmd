---
title: "Day 1 Morning Exercise -- Solution"
---
...
A conservative strategy would only recommend treatment when the lower
limit of the predicted risk is above the threshold, an aggressive
strategy would recommend treatment when the upper limit exceeds the
threshold.
